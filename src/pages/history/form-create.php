...
<?php
  ...
  // $sqlUser = "SELECT * FROM `item_user` WHERE id = '".$_SESSION['authen_id']."'";
        ...
        <form action="create.php" method="post" enctype="multipart/form-data">
          <div class="card-body">
            ...
            <div class="col-12 col-sm-6 col-md-6 col-lg-6 p-2">
                ...
                <option value="<?php echo$_SESSION['authen_id']; ?>"><?php echo $rowUser['emp_id']; ?> <?php echo $rowU['emp_name']; ?></option>
          ...
          <div class="card-footer">
            <center>
              ...
              <a href="../use_lend" class="btn btn-danger" type="button">ยกเลิก</a></button>
            </center>
          </div>
        </form>
      </div>    
