    ...
    <section class="content">
      <div class="card card-warning">
        ...
        <form role="form" action="" method="post">
          ...
          <div class="row">
              <div class="col-12 col-sm-4 col-md-2 col-lg-2 p-2">
                <label for="approved_by">จัดการโดย</label>
              </div>
              <div class="col-12 col-sm-8 col-md-10 col-lg-10 p-2">
          ...
          <div class="row">
              <div class="col-12 col-sm-4 col-md-2 col-lg-2 p-2">
                <label for="approved_date">ยืม/เบิกวันที่</label>
              </div>
              <div class="col-12 col-sm-8 col-md-10 col-lg-10 p-2">
          ...
          <div class="row">
              <div class="col-12 col-sm-4 col-md-2 col-lg-2 p-2">
                <label for="returned_date">คืนวันที่</label>
              </div>
              <div class="col-12 col-sm-8 col-md-10 col-lg-10 p-2">
