    ...
    <section class="content">
      <div class="card card-primary">
        ...
        <form action="update.php" method="post" enctype="multipart/form-data">
          ...
          <center>
            <button type="submit" name="submit" class="btn btn-primary">Return Item</button>
            <a href="../history" class="btn btn-danger" type="button">Cancel</a></button>
          </center>
          </div>
      </form> 
      </div>    
