          ...
          <div class="card-body">
            ...
            <div class="form-group row">
              ...
              <div class="col-12 col-sm-6 col-md-6 col-lg-6 p-2">
                ...
                <input type="text" class="form-control" id="emp_name" name="emp_name" placeholder="Emp. Name" value="<?php echo $row['emp_name']; ?>" required>
              </div>
              <div class="col-12 col-sm-6 col-md-6 col-lg-6 p-2">
                <label for="department">แผนก/สาขา</label>
                <textarea  type="text" class="form-control" id="department" name="department" rows="1" placeholder="Department"><?php echo $row['department']; ?></textarea>
              </div>     
              <div class="col-12 col-sm-6 col-md-6 col-lg-6 p-2">
                <label for="position">ตำแหน่ง</label>
                <textarea  type="text" class="form-control" id="position" name="position" rows="1" placeholder="Position"><?php echo $row['position']; ?></textarea>
              </div>                  
            </div>
