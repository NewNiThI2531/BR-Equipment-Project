...
<div class="wrapper">
  ...
  <?php 
    $sql = "SELECT * FROM `view_itemborrowreturn` WHERE `status` = 'Pending' ORDER BY id ASC";
    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title d-inline-block">Approve Info List</h3>
          <!-- <a href="form-c.php" class="btn btn-info float-right ">Add Person Info  +</a href=""> -->
          <!-- <a href="form-create.php" class="btn btn-info float-right ">Add Use & Lend +</a href=""> -->
        </div>
        <!-- /.card-header -->
